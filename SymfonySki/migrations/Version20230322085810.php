 ...
 */
final class Version20230322085810 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE piste (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, difficulty INT NOT NULL, open_hour DATE NOT NULL, close_hour DATE NOT NULL, fermeture TINYINT(1) NOT NULL, fermeture_message VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
